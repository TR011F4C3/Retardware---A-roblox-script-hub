...
local Vaporware = Instance.new("ScrollingFrame")
...
Vaporware.Name = "Waveware"
Vaporware.Parent = ScreenGui
Vaporware.Active = true
Vaporware.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
Vaporware.BorderColor3 = Color3.fromRGB(67, 67, 67)
Vaporware.Position = UDim2.new(0.00670141494, 0, 0.15552099, 0)
Vaporware.Size = UDim2.new(0, 340, 0, 278)
Vaporware.CanvasSize = UDim2.new(0, 0, 10, 0)
Vaporware.VerticalScrollBarInset = Enum.ScrollBarInset.ScrollBar
Vaporware.Draggable=true

Crazy.Name = "Crazy"
Crazy.Parent = Vaporware
...
local function ITBVL_fake_script() -- Vaporware.Script 
	local script = Instance.new('Script', Vaporware)
